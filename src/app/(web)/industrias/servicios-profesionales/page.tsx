              ...
              <div className="relative">
                ...
                {isIndustriasOpen && (
                  <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10">
                    ...
                    <Link href="/industrias/salud" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Salud
                    </Link>
                    <Link
            ...
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
                ...
                <div>
                  ...
                  {isIndustriasOpen && (
                    <div className="pl-4 space-y-1">
                      ...
                      <Link href="/industrias/salud" className="block px-3 py-2 text-sm text-gray-700">
                        Salud
                      </Link>
                      <Link
                        href="/industrias/servicios-profesionales"
                ...
                <div className="px-3 py-2">
                  <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white">Prueba Gratis</Button>
                </div>
              </div>
            </div>
          )}
