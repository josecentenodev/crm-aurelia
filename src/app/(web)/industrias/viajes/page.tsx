...
import { Button, Badge, Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components"
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link href="/#features" className="text-gray-600 hover:text-blue-600 transition-colors font-geomanist">
              Características
            </Link>
            <Link href="/#agents" className="text-gray-600 hover:text-blue-600 transition-colors font-geomanist">
              Agentes IA
            </Link>
            <div className="relative group">
              <button className="text-gray-600 hover:text-blue-600 transition-colors font-geomanist flex items-center">
                Industrias
              ...
              <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <div className="py-2">
                  <Link
                    ...
                    className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 font-geomanist"
                  >
                    Educación
                  </Link>
                  <Link
                    href="/industrias/viajes"
                    className="block px-4 py-2 text-blue-600 bg-blue-50 font-geomanist font-semibold"
                  >
                    Viajes
                  </Link>
                  <Link
            ...
            <Link href="/pricing" className="text-gray-600 hover:text-blue-600 transition-colors font-geomanist">
              Precios
            </Link>
          </nav>
          <div className="flex items-center space-x-4">
            ...
            <Button className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 font-geomanist">
              Prueba Gratis
            </Button>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <Link href="/industrias/inmobiliaria" className="hover:text-white transition-colors font-geomanist">
                    Inmobiliaria
                  </Link>
                </li>
              </ul>
